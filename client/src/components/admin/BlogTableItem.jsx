...
const BlogTableItem = ({blog,fetchBlogs,index}) => {
  ...
  return (
    <tr className='border-y border-gray-300'>
        ...
        <td className='px-2 py-4 max-md:hidden'>{blogDate.toDateString()}</td>
        <td className='px-2 py-4 max-md:hidden'>
        ...
        <td className='px-2 py-4 text-xs gap-3 flex '>
            <button onClick={togglePublish} className='rounded mt-1 px-2 py-0.5 border cursor-pointer'> 
