  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
          ...
          <p className='m-6 sm:my-8 max-w-2xl mx-auto max-sm:text-xs text-gray-500'>This is your space to think out loud, to share what matters and to write without filters. Wheather it is one word or thousand, your story start write here.</p>
