  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <h2 className='my-5 truncate mx-auto max-w-lg '>{data.subTitle}</h2>
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm font-medium text-primary border-primary/35 bg-primary/5'>Arnab Ghosh</p>
      </div>
